...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ route('user.create') }}" class="btn btn-primary" class="btn btn-primary mt-3">Add user</a>
              <div class="card mt-3">
                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td>{{ $d->email }}</td>
                                <td>
                                    <a href="{{ route('user.edit', ['id' => $d->id]) }}" class="btn btn-primary"><i class="fas fa-edit"></i>Edit</a>
